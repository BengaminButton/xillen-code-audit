...
удит кода: правила безопасности, метрики, JSON-отчёты.
...
## становка
- лонируйте репозиторий: git clone https://github.com/BengaminButton/xillen-code-audit.git
- ерейдите в каталог: cd xillen-code-audit
